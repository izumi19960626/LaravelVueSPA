        ...
        <article class="col-md-8 col-xs-12">
          <section>
            <h2 class="quiz-question-h2">
              <img class="quiz-question_logo" src="public/img/what-is-mark.png" />
              第1問
            </h2>
          ...
          <section>
            <h2 class="quiz-correct-h2">
              <img class="quiz-correct_logo" src="public/img/correct-mark.png" />正解
            </h2>
            <p>
          ...
          <section >
            <h2 class="quiz-commentary-h2">
              <img class="quiz-commentary_logo" src="public/img/commentary-mark.png" />解説
            </h2>
            <div class="quiz-commentary_text">
