        ...
        <article class="col-md-8 col-xs-12">
          <section class="home-quiz_introduction">
            <h2 class="home-quiz_introduction-h2">
              <img class="home-quiz_introduction-h2-logo" src="/img/what-is-mark.png" />4 Answers Quizとは?
            </h2>
          ...
          <section class="home-quiz_setting">
            <h2 class="home-quiz_setting-h2">
              <img class="home-quiz_setting-h2-logo" src="/img/directory-icon.png" />出題設定
            </h2>
          ...
          <section class="home-quiz_ranking">
            <h2 class="home-quiz_ranking-h2">
              <img class="home-quiz_ranking-h2-logo" src="/img/graph-icon.png" />ランキング
            </h2>
            <div>
              <label>
            ...
            <div class="home_quiz_ranking-chart">
             <bar-chart></bar-chart>
            </div>
          </section>
          <section class="home_notice">
            <h2 class="home_notice-h2">
              <img class="home_notice-h2-logo" src="/img/news-icon.png" />お知らせ情報
            </h2>
            <dl>
              <dt>2019/08/23</dt>
              <dd>サイトを開設しました。</dd>
